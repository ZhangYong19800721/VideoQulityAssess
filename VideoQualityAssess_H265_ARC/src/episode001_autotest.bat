...
#提取YUV文件
 ...
 ffmpeg -i NETFLIX_4096x2160_30fps_420p_200000K.split0001-arc-x265-15000K.mp4      -f rawvideo -pix_fmt yuv420p out_episode001_15000K.yuv
 ...
 ffmpeg -i NETFLIX_4096x2160_30fps_420p_200000K.split0001-arc-x265-05000K.mp4      -f rawvideo -pix_fmt yuv420p out_episode001_05000K.yuv
