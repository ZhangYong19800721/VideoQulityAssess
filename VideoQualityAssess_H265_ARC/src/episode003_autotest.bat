...
#提取YUV文件
 ...
 ffmpeg -i NETFLIX_4096x2160_30fps_420p_200000K.split0003-arc-x265-15000K.mp4      -f rawvideo -pix_fmt yuv420p out_episode003_15000K.yuv
 ...
 ffmpeg -i NETFLIX_4096x2160_30fps_420p_200000K.split0003-arc-x265-05000K.mp4      -f rawvideo -pix_fmt yuv420p out_episode003_05000K.yuv
 
 matlab -nosplash -nodesktop -logfile log.txt -r main_episode003
 del out_episode003_20000K.yuv
 del out_episode003_15000K.yuv
