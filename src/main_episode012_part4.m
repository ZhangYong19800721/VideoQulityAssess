clear all;
close all;
numOfFrame = 780; %×¢ÒâÐÞ¸Ä
frameWidth = 4096;
frameHeight = 2160;

SourceVideo      = 'out_episode012_99000K.yuv';
RecoverVideo_02500K = 'out_episode012_02500K.yuv';
RecoverVideo_02000K = 'out_episode012_02000K.yuv';
RecoverVideo_01500K = 'out_episode012_01500K.yuv';
RecoverVideo_01000K = 'out_episode012_01000K.yuv';
RecoverVideo_00500K = 'out_episode012_00500K.yuv';
...
save('episode012_result_part4.mat');
