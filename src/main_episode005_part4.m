clear all;
close all;
numOfFrame = 1050; %×¢ÒâÐÞ¸Ä
frameWidth = 4096;
frameHeight = 2160;

SourceVideo      = 'out_episode005_99000K.yuv';
RecoverVideo_02500K = 'out_episode005_02500K.yuv';
RecoverVideo_02000K = 'out_episode005_02000K.yuv';
RecoverVideo_01500K = 'out_episode005_01500K.yuv';
RecoverVideo_01000K = 'out_episode005_01000K.yuv';
RecoverVideo_00500K = 'out_episode005_00500K.yuv';
...
[Q01500K cdf01500K pdf15000K Qf15000K] = VideoDiffPDF(SourceVideo,RecoverVideo_01500K,numOfFrame,frameWidth,frameHeight);
...
[PSNR01500K PSNRf15000K] = VideoPSNR(SourceVideo,RecoverVideo_01500K,numOfFrame,frameWidth,frameHeight);
...
[SSIM01500K SSIMf15000K] = VideoSSIM(SourceVideo,RecoverVideo_01500K,numOfFrame,frameWidth,frameHeight);
...
save('episode005_result_part4.mat');
